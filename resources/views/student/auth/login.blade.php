    ...
    <form method="POST" action="{{ route('student.login') }}">
        ...
        <div class="row main mx-auto w-75 mt-5  d-flex">
            ...
            <div class="col-md-6 p-5">
                ...
                <div class="row">
                    <h2 class="head  mt-2 text-center">Login</h2>
                    <input name="user_name" type="email" class="form-control mb-4 bg-transparent" placeholder="Email">
                    <input name="password" type="text" class="form-control mb-4 bg-transparent" placeholder="Password">
