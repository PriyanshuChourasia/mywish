            ...
            success: function(data)
                {
                    ...
                    {
                        $('#course_permit').show();
                        $('#subject_register').val('Request');
                    }else if(data.permit != 0)
                    {
                        $('#course_permit').hide();
                        $('#subject_register').val('Your have an active course');
                        $('#subject_register').prop('disabled',true);
                    }
                }
        });
    });
