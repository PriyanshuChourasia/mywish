                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="fees" id="fees" class="form-control" value="{{$subject->fees}}">
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <input type="submit" value="{{__('Update Subject')}}" class="btn btn-dark rounded-2" id="subject_btn">
                </div>
            </form>
        </div>
...
<script>
    $(document).ready(function(){
        $('#edit_subject').on("submit", function(e){
            ...
            $.ajax({
                url: "{{route('admin.update_subject',$subject->id)}}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
