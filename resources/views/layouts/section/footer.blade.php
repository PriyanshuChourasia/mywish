        ...
        <div class="container" id="footer">
            <div class="row gy-4">
                <div class="col-lg-5 col-md-6 footer-info">
                    <a href=""
                        class="text-decoration-none logo d-flex align-items-center fw-bold  fs-2"
                        style="color:#ffffff;">
            ...
            <div class=" row d-flex mt-4 m-auto">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-3"><a href="https://www.facebook.com/samir.ram1?mibextid=ZbWKwL"
                                class="facebook " title="click me">
                        ...
                        <div class="col-md-3">
                            <a href="https://instagram.com/samirram007?igshid=MzRlODBiNWFlZA=="
                                class="instagram" title="click me">
                                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38"
